...
function Page() {
  return (
    <div className="mx-auto p-4 bg-secondary-lightGray">
      ...
      <p>Outside of work, I enjoy contributing to open source projects, writing technical articles, and sharing my knowledge through speaking engagements at industry conferences.</p>
    </div>
  );
}
