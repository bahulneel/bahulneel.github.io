...
import { faHome, faUser, faBriefcase, faCode, faEnvelope, faBars, faTimes, faProjectDiagram, faPenNib, faLightbulb } from '@fortawesome/free-solid-svg-icons';
      ...
      <nav className="container mx-auto flex justify-between items-center" itemProp="navigation">
        ...
        <div className={`relative ${isMenuOpen ? 'block' : 'hidden'} md:block`} itemProp="menu">
          ...
          <div className="flex-col md:flex-row md:flex space-x-0 md:space-x-4">
            <Link href="/" legacyBehavior><a className="hover:text-accent-white text-accent-lightBlue md:inline flex items-center no-underline text-center" itemProp="url"><FontAwesomeIcon icon={faHome} className="mr-2" />Home</a></Link>
            <Link href="/about" legacyBehavior><a className="hover:text-accent-white text-accent-lightBlue md:inline flex items-center no-underline text-center" itemProp="url"><FontAwesomeIcon icon={faUser} className="mr-2" />About</a></Link>
            ...
            <Link href="/research-design" legacyBehavior><a className="hover:text-accent-white text-accent-lightBlue md:inline flex items-center no-underline text-center" itemProp="url"><FontAwesomeIcon icon={faLightbulb} className="mr-2" />Research &amp; Design</a></Link>
