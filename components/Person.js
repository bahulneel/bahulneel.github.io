...
const Person = () => {
  return (
    <div className="flex flex-col lg:flex-row-reverse items-center prose prose-sm sm:prose-lg lg:prose-xl p-4 sm:p-6 lg:p-8" itemscope itemtype="https://schema.org/Person">
